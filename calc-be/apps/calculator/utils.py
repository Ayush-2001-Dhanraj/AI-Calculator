...
def analyze_image(img: Image, dict_of_vars: dict):
    ...
    prompt = (
        ...
        f"Return only a valid Python list of dictionaries, like this: "
        f'[{{"expr": "x", "result": 2, "assign": true}}]. '
        f"Do not include any extra text or explanation before or after the list. Use double quotes for all keys and string values. Ensure `true`/`false` are lowercase if you format it as JSON."
    )
